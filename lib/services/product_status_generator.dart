...
class ProductStatusGenerator {
  ...
  static ProductStatus generateStatus({
    ...
    try {
      ...
      return ProductStatus(
        ...
        appearanceProfile:
            environmentalAdjustments['appearance'] ?? appearanceProfile,
  ...
  static MaillardReactionResult _calculateMaillardReaction(
    ...
    final temperature =
        (bakingContext['suggestedTemperature'] as int? ?? 180).toDouble();
    final timeMinutes =
        (bakingContext['suggestedTimeMinutes'] as int? ?? 30).toDouble();
  ...
  static Map<String, dynamic> _applyEnvironmentalFactors(
    ...
    // 온도 영향
    final temperature =
        environmentalConditions['temperature'] as double? ?? 26.0;
    if (temperature > 30) {
...
class ProductStatus {
  ...
  String get detailedDescription {
    ...
    buffer.writeln(
        "👁️ 외관: ${appearanceProfile.crustTexture} ${appearanceProfile.crustColor} 크러스트");
