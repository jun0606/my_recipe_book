...
class UnitConversionEngine {
  ...
  double _convertUnit({
    ...
    if (weightConversions.containsKey(fromUnit) && volumeConversions.containsKey(toUnit)) {
    ...
    if (volumeConversions.containsKey(fromUnit) && weightConversions.containsKey(toUnit)) {
      final density = _getIngredientDensity(ingredientName);
      final ml = amount * volumeConversions[fromUnit]!;
