...
class FermentationNotificationService {
  ...
  static const String _notificationEnabledKey =
      'fermentation_notification_enabled';
  ...
  Future<void> _playStartSound() async {
    print('🔊 시작 알림 재생 시도...');
    await _playMultiMethodSound(
        '시작', SystemSoundType.click, HapticFeedback.lightImpact);
  }
  ...
  Future<void> _playCompleteSound() async {
    print('🔊 완료 알림 재생 시도...');
    await _playMultiMethodSound(
        '완료', SystemSoundType.alert, HapticFeedback.mediumImpact);
  }
  ...
  Future<void> _playCheckpointSound() async {
    ...
    await _playMultiMethodSound(
        '체크포인트', SystemSoundType.click, HapticFeedback.selectionClick);
  }
  ...
  Future<void> _playMultiMethodSound(
      ...
      Future<void> Function() hapticFallback) async {
    bool soundPlayed = false;
  ...
  /// 시작 알림
  Future<void> _showStartNotification(
      String stageName, Duration duration) async {
  ...
  Future<void> _showCompleteNotification(
      String stageName, String? nextStageName) async {
    const notificationDetails = NotificationDetails(
      android: AndroidNotificationDetails(
        'fermentation_timer',
        '발효 타이머',
    ...
    final body =
        nextStageName != null ? '다음 단계: $nextStageName' : '발효 단계가 완료되었습니다';
