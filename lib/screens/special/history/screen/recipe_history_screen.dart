...
class _RecipeHistoryScreenState extends State<RecipeHistoryScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      final histories = await RecipeHistoryService.instance
          .getFilteredHistories(_currentFilter);
        ...
        child: Column(
          ...
          children: [
            ...
            ..._stats!.categoryDistribution.entries.map((entry) {
              final percentage =
                  (entry.value / _stats!.totalOptimizations * 100).toInt();
              return Padding(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                  '개선도', '${(history.improvementScore * 100).toInt()}%'),
