...
class AnalysisOptions {
  ...
  AnalysisOptions copyWith({
    ...
    return AnalysisOptions(
      ...
      generateRecommendations: generateRecommendations ?? this.generateRecommendations,
      includeNutritionalAnalysis: includeNutritionalAnalysis ?? this.includeNutritionalAnalysis,
      includeCostAnalysis: includeCostAnalysis ?? this.includeCostAnalysis,
      includeEnvironmentalImpact: includeEnvironmentalImpact ?? this.includeEnvironmentalImpact,
      includeAllergyAnalysis: includeAllergyAnalysis ?? this.includeAllergyAnalysis,
  ...
  factory AnalysisOptions.fromJson(Map<String, dynamic> json) {
    return AnalysisOptions(
      ...
      enableParallelProcessing: json['enableParallelProcessing'] as bool? ?? true,
      ...
      includeNutritionalAnalysis: json['includeNutritionalAnalysis'] as bool? ?? true,
      includeCostAnalysis: json['includeCostAnalysis'] as bool? ?? false,
      includeEnvironmentalImpact: json['includeEnvironmentalImpact'] as bool? ?? false,
