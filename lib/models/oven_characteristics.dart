...
import 'package:my_recipe_book/models/advanced_sous_chef_models.dart'; // For OvenType

part 'oven_characteristics.g.dart'; // Assuming code generation for json_serializable
