  ...
  group('RecipeHistory 모델 테스트', () {
    test('RecipeHistory 생성 및 JSON 변환', () {
      ...
      final history = RecipeHistory.create(
        ...
        environmentalConditions: {'temperature': 26.0, 'humidity': 60.0, 'altitude': 0.0},
  ...
  group('RecipeHistoryStats 테스트', () {
    test('통계 생성', () {
      ...
      for (int i = 0; i < 2; i++) {
        histories.add(RecipeHistory.create(
          ...
          beforeStatus: ProductStatusHistory(
            textureProfile: '보통', flavorProfile: ['기본'], appearanceProfile: '보통',
            textureScore: 0.6, flavorScore: 0.6, appearanceScore: 0.6, confidenceLevel: 0.7,
          ),
          afterStatus: ProductStatusHistory(
            textureProfile: '우수', flavorProfile: ['풍부'], appearanceProfile: '우수',
            textureScore: 0.9, flavorScore: 0.8, appearanceScore: 0.8, confidenceLevel: 0.9,
          ),
          optimizationNotes: [],
        ));
      }
      ...
      histories.add(RecipeHistory.create(
        ...
        beforeStatus: ProductStatusHistory(
          textureProfile: '보통', flavorProfile: ['기본'], appearanceProfile: '보통',
          textureScore: 0.7, flavorScore: 0.7, appearanceScore: 0.7, confidenceLevel: 0.7,
        ),
        afterStatus: ProductStatusHistory(
          textureProfile: '보통', flavorProfile: ['기본'], appearanceProfile: '보통',
          textureScore: 0.6, flavorScore: 0.6, appearanceScore: 0.6, confidenceLevel: 0.6,
        ),
        optimizationNotes: [],
      ));
  ...
  group('RecipeHistoryFilter 테스트', () {
    test('필터링 동작', () {
      final history1 = RecipeHistory.create(
        ...
        environmentalConditions: {},
        beforeStatus: ProductStatusHistory(
          textureProfile: '', flavorProfile: [], appearanceProfile: '',
          textureScore: 0.6, flavorScore: 0.6, appearanceScore: 0.6, confidenceLevel: 0.7,
        ),
        afterStatus: ProductStatusHistory(
          textureProfile: '', flavorProfile: [], appearanceProfile: '',
          textureScore: 0.8, flavorScore: 0.8, appearanceScore: 0.8, confidenceLevel: 0.8,
        ),
        optimizationNotes: [],
      );
      ...
      final history2 = RecipeHistory.create(
        ...
        beforeStatus: ProductStatusHistory(
          textureProfile: '', flavorProfile: [], appearanceProfile: '',
          textureScore: 0.5, flavorScore: 0.5, appearanceScore: 0.5, confidenceLevel: 0.6,
        ),
        afterStatus: ProductStatusHistory(
          textureProfile: '', flavorProfile: [], appearanceProfile: '',
          textureScore: 0.5, flavorScore: 0.5, appearanceScore: 0.5, confidenceLevel: 0.6,
      ...
      // 타입 필터
      final typeFilter = RecipeHistoryFilter(type: RecipeHistoryType.optimization);
