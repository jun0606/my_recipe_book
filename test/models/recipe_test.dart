  ...
  group('Recipe Model Tests', () {
    test('should serialize and deserialize correctly', () {
      ...
      for (int i = 0; i < recipe.ingredients.length; i++) {
        expect(deserializedRecipe.ingredients[i].name, recipe.ingredients[i].name);
        expect(deserializedRecipe.ingredients[i].amount, recipe.ingredients[i].amount);
        expect(deserializedRecipe.ingredients[i].unit, recipe.ingredients[i].unit);
      }
    ...
    test('should handle malformed JSON gracefully', () {
      ...
      expect(recipe.instructions, contains('invalid json')); // Fallback to string list
    });
  });
}
