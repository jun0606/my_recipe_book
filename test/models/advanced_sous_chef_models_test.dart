...
void main() {
  ...
  group('Ingredient 모델 테스트', () {
    test('밀가루 판별이 정확해야 함', () {
      const flour1 = Ingredient(name: '강력분', amount: 500, unit: 'g', properties: {});
      const flour2 = Ingredient(name: 'bread flour', amount: 500, unit: 'g', properties: {});
      const notFlour = Ingredient(name: '설탕', amount: 50, unit: 'g', properties: {});
    ...
    test('물 판별이 정확해야 함', () {
      const water1 = Ingredient(name: '물', amount: 350, unit: 'g', properties: {});
      const water2 = Ingredient(name: 'water', amount: 350, unit: 'g', properties: {});
      const milk = Ingredient(name: '우유', amount: 200, unit: 'ml', properties: {});
      const notWater = Ingredient(name: '설탕', amount: 50, unit: 'g', properties: {});
    ...
    test('소금 판별이 정확해야 함', () {
      const salt1 = Ingredient(name: '소금', amount: 10, unit: 'g', properties: {});
      const salt2 = Ingredient(name: 'salt', amount: 10, unit: 'g', properties: {});
      const notSalt = Ingredient(name: '설탕', amount: 50, unit: 'g', properties: {});
    ...
    test('이스트 판별이 정확해야 함', () {
      const yeast1 = Ingredient(name: '이스트', amount: 5, unit: 'g', properties: {});
      const yeast2 = Ingredient(name: 'yeast', amount: 5, unit: 'g', properties: {});
      const yeast3 = Ingredient(name: '효모', amount: 5, unit: 'g', properties: {});
      const notYeast = Ingredient(name: '설탕', amount: 50, unit: 'g', properties: {});
