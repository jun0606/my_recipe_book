  ...
  group('FermenterGuideManager Tests', () {
    ...
    setUp(() {
      testRecipe = RecipeAnalysis(
        ...
        yeastStatus: 'optimal',
        sugarStatus: 'optimal',
        optimizationTips: ['중수분', '일반당분'],
        estimatedFermentationTimeMinutes: 120,
    ...
    test('calculateOptimalSettings - 고당분 레시피 조정', () {
      final highSugarRecipe = RecipeAnalysis(
        ...
        ingredients: {'flour': 100.0, 'water': 70.0, 'yeast': 1.5, 'sugar': 20.0},
    ...
    test('calculateOptimalSettings - 고이스트 레시피 조정', () {
      final highYeastRecipe = RecipeAnalysis(
        ...
        ingredients: {'flour': 100.0, 'water': 70.0, 'yeast': 2.5, 'sugar': 10.0},
        flourPercentage: 100.0,
    ...
    test('calculateOptimalSettings - 고수분 레시피 조정', () {
      final highHydrationRecipe = RecipeAnalysis(
        ...
        ingredients: {'flour': 100.0, 'water': 80.0, 'yeast': 1.5, 'sugar': 10.0},
        flourPercentage: 100.0,
        sugarPercentage: 10.0,
        yeastPercentage: 1.5,
    ...
    test('generateSettingInstructions - 스마트 발효기', () {
      ...
      final tempInstruction = instructions.firstWhere((i) => i.title == '온도 설정');
    ...
    test('calculateSafeStorageSettings - 냉장 보관', () {
      final storageSettings = FermenterGuideManager.calculateSafeStorageSettings(
    ...
    test('compareSettings - 설정 비교', () {
      ...
      expect(comparison['comparison']['temperature']['difference'], equals('2.0'));
    });
