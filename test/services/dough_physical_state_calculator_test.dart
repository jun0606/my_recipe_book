  ...
  group('DoughPhysicalStateCalculator Tests', () {
    ...
    group('레시피 분석 테스트', () {
      test('표준 빵 레시피 분석이 정확해야 함', () {
        ...
        // Then
        expect(state.ingredientRatios.flourProteinPercentage, equals(13.0)); // 강력분
        expect(state.ingredientRatios.saltPercentage, equals(2.0)); // 10/500 * 100
        expect(state.ingredientRatios.fatPercentage, equals(5.0)); // 25/500 * 100
        expect(state.ingredientRatios.sugarPercentage, equals(3.0)); // 15/500 * 100
        expect(state.ingredientRatios.hydrationPercentage, equals(64.0)); // 320/500 * 100
      ...
      test('케이크 레시피 분석이 정확해야 함', () {
        ...
        // Then
        expect(state.ingredientRatios.flourProteinPercentage, equals(8.5)); // 박력분
        expect(state.ingredientRatios.saltPercentage, equals(1.0)); // 2/200 * 100
        expect(state.ingredientRatios.fatPercentage, equals(50.0)); // 100/200 * 100
        expect(state.ingredientRatios.sugarPercentage, equals(75.0)); // 150/200 * 100
        expect(state.ingredientRatios.hydrationPercentage, equals(40.0)); // 80/200 * 100
    ...
    group('데이터 모델 테스트', () {
      test('DoughPhysicalState JSON 직렬화/역직렬화가 정상 동작해야 함', () {
        ...
        // Then
        expect(deserializedState.glutenStrengthIndex, equals(originalState.glutenStrengthIndex));
        expect(deserializedState.quality, equals(originalState.quality));
        expect(deserializedState.suggestions.length, equals(originalState.suggestions.length));
        expect(deserializedState.ingredientRatios, equals(originalState.ingredientRatios));
        expect(deserializedState.calculatedAt, equals(originalState.calculatedAt));
      });
