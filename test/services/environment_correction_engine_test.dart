...
void main() {
  group('환경 보정 엔진 테스트', () {
    ...
    test('통합 보정 계산이 정확해야 함', () {
      ...
      final result = EnvironmentCorrectionEngine.calculateIntegratedCorrection(conditions);
    ...
    test('발효 시간 보정이 올바르게 적용되어야 함', () {
      ...
      final correction = EnvironmentCorrectionEngine.calculateIntegratedCorrection(conditions);
      
      final correctedTime = EnvironmentCorrectionEngine.applyFermentationTimeCorrection(
        120,
        correction,
      );
    ...
    test('최적 환경 진단이 정확해야 함', () {
      ...
      final diagnosis = EnvironmentCorrectionEngine.diagnoseEnvironment(optimalConditions);
